from Projects.practice.Task_Manager.tasks import add_task, view_tasks, update_task, delete_task
from Projects.practice.Task_Manager.notifications import schedule_task_reminder
from Projects.practice.Task_Manager.database import create_tables  # Import create_tables to initialize the database
