...
This program simulates a digital clock that displays both 12-hour and 24-hour formats simultaneously.
It allows the user to add hours, minutes, and seconds, or exit the program via a menu.
*/
