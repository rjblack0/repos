...
- **CS-465 – Full Stack Development**
  ...
  - Focus: frontend/backend integration, API design, authentication, client-server architecture

- **CS-340 – Client Server Development**
  - Project: Dashboard application with MongoDB + Dash
  - Focus: database integration, RESTful design, data visualization, modular architecture

- **CS-360 – Mobile Architecture and Programming**
  - Project: Mobile application (Android)
  - Focus: mobile UI/UX, application structure, platform-specific development
...
- **CS-305 – Software Security**
  ...
  - Focus: secure coding practices, threat modeling, encryption, dependency analysis
...
- These courses contributed to foundational knowledge but are less directly relevant to current roles:
  ...
  - IT-140 – Fundamentals of Programming
